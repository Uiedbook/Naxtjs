declare module "naxt" {
  ...
  export class Element {
    ...
    appendChild(child: Element | string): void;
    setAttribute(key: string, value: any): void;
    addEventListener(key: string, Listener: any): void;
  }
  ...
  export function compileHTML(Naxt_Element_Tree: any): Promise<string>;
  ...
  export function css(
    identifier: string | TemplateStringsArray
  ...
  class naxtrouter {
     ...
     * @param force boolean
     */
    loadScreen(url: string, data?: unknown, force?: boolean): Promise<string>;
    /**
     * cradova router
     * ---
     * Registers routes.
     ...
     * @param option
     */
    listen(option: { port?: number; debug?: boolean }): Promise<void>;
  }
  export const Router: naxtrouter;
  ...
  export class Screen {
     ...
     */
    _secondaryChildren: Array<Element>;
    /**
